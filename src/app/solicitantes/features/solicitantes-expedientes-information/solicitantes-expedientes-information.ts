...
@Component({
  selector: 'app-solicitantes-expediente-information',
  standalone: true,
  imports: [HeadingTitleComponent, AsyncPipe, DatePipe],
  templateUrl: './solicitantes-expedientes-information.html',
  styles: ``
})
export default class SolicitantesExpedienteInformationComponent {
